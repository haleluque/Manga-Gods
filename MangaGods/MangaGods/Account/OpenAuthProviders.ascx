<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="MangaGods.Account.OpenAuthProviders" %>

<div id="socialLoginList">
    <h4>Use una cuenta externa para ingresar.</h4>
    <hr />
