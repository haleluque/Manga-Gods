...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:FileUpload ID="Archivo" runat="server" CssClass="form-control" />
    ...
    <div class="form-horizontal">
        ...
        <hr />
        <div class="form-group">
            <asp:Label ID="lblId" CssClass="col-md-2 control-label" runat="server" Text="<%$ Resources:RecursosMangaGods, lblId %>"></asp:Label>
            <div class="col-md-10">
        ...
        <div id="datosManga" runat="server" visible="false">
            <div class="form-group">
                <asp:Label ID="lblMangaConsulta" CssClass="col-md-2 control-label" runat="server" Text="<%$ Resources:RecursosMangaGods, lblNombre %>"></asp:Label>
                <div class="col-md-10">
            ...
            <div class="form-group">
                <asp:Label ID="lblAutorConsulta" runat="server" CssClass="col-md-2 control-label" Text="<%$ Resources:RecursosMangaGods, lblNombreAutor %>"></asp:Label>
                <div class="col-md-10">
                    <asp:DropDownList ID="comboAutorConsulta" CssClass="form-control combo-box" runat="server" AppendDataBoundItems="true" DataTextField="Nombre" DataValueField="Id"></asp:DropDownList>
            ...
            <div class="form-group">
                <asp:Label ID="lblVolumenConsulta" runat="server" CssClass="col-md-2 control-label" Text="<%$ Resources:RecursosMangaGods, lblVolumen %>"></asp:Label>
                <div class="col-md-10">
                    ...
                    <asp:RequiredFieldValidator ID="requeridoVolumenConsulta" ValidationGroup="grupoActualizar" runat="server" Text="<%$ Resources:RecursosMangaGods, spanErrorVolumen %>"
                        ControlToValidate="txtVolumenConsulta" SetFocusOnError="true" Display="Dynamic" CssClass="text-danger">
                    </asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="expresionVolumenConsulta" ValidationGroup="grupoActualizar" runat="server" Text="<%$ Resources:RecursosMangaGods, spanErrorFormatoId %>"
                        ControlToValidate="txtVolumen" SetFocusOnError="True" Display="Dynamic" ValidationExpression="^[0-9]*$" CssClass="text-danger">
                    </asp:RegularExpressionValidator>
                </div>
            </div>
            <div class="form-group">
                <asp:Label ID="lblPrecioConsulta" runat="server" CssClass="col-md-2 control-label" Text="<%$ Resources:RecursosMangaGods, lblPrecio %>"></asp:Label>
                <div class="col-md-10">
                    ...
                    <asp:RegularExpressionValidator ID="expresionPrecioConsulta" runat="server" Text="<%$ Resources:RecursosMangaGods, spanErrorFormatoPrecio %>"
                        ControlToValidate="txtPrecioConsulta" SetFocusOnError="True" Display="Dynamic" ValidationExpression="^[0-9]*(\.)?[0-9]?[0-9]?$"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:FileUpload ID="archivoConsulta" runat="server" CssClass="form-control" />
